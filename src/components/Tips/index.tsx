...
export function Tips() {
    ...
    const tipsForWhenActiveTask = {
        ...
        shortBreakTime: ( // Corrigido: era shortBreaktime, agora é shortBreakTime
            <span> Descanse por <b>{state.config.shortBreakTime}</b> minutos</span>
        ),
    ...
    const tipsForNoActiveTask = {
        ...
        shortBreakTime: ( // Corrigido: era shortBreaktime, agora é shortBreakTime
            <span> Próximo descanso é de <b>{state.config.shortBreakTime}</b> minutos</span>
        ),
